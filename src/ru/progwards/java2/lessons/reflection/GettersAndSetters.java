...
/*
Реализовать метод public static check(String clazz) который анализирует, для каких private полей класса нет сеттера или геттера и выводит на консоль сигнатуры отсутствующих методов;
...
Сеттер это public не static метод setИмяСвойства c одним параметром с типом, совпадающим с типом свойства.
