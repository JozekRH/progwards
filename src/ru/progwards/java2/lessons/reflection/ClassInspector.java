...
/*
Реализовать метод public static void inspect(String clazz), который выводит в файл с именем равным имени класса и расширением java содержимое класса в формате:
